...
const ServicesPage = () => {
  ...
  // Naya Data: Internal Softwares (Read from Image Context)
  const softwareSuite = [
    {
      icon: <FiSearch size={22} />,
      title: "TAZ Scout",
      badge: "Market Scout Node",
      // (The New Era of Advanced Trading)
      desc: "Advanced institutional footprint hunter algorithms, designed for real-time market scouting.",
      image: "https://images.unsplash.com/photo-1642790106117-e829e14a795f?auto=format&fit=crop&w=800&q=80"
    },
    {
      icon: <FiLayers size={22} />,
      title: "TAZ Tratry",
      badge: "Trading Execution Node",
      // (Trading System / System Framework)
      desc: "Comprehensive trading framework and complete system mapping matrices.",
      image: "https://images.unsplash.com/photo-1642790106117-e829e14a795f?auto=format&fit=crop&w=800&q=80"
    }
  ];
  ...
  const mainEcosystemServices = [
    ...
    },
    {
      ...
      desc: "Live order flow deployment aur standard risk mitigation protocols guidelines.",
      image: Hamza_image_2
    }
  ];
  ...
  return (
    <div className="bg-[#010413] text-white min-h-screen py-16 px-4 md:px-6 relative font-sans overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-24">
        ...
        {/* --- NEW SECTION 2: PRO LAB SOFTWARE SUITE (From Image Context) --- */}
        <div className="space-y-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/5 pb-4">
            <div className="flex items-center gap-3">
              <FaCodeBranch size={16} className="text-blue-500" />
              <h2 className="text-2xl font-black uppercase italic tracking-tight">Software Lab Modules</h2>
            </div>
            <p className="text-[9px] font-black text-blue-500 uppercase tracking-widest">Read from TAZ Operations Image</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
            {softwareSuite.map((tool, i) => (
              <motion.div
                key={tool.title}
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="group flex flex-col md:flex-row bg-[#040d21]/60 border border-blue-500/20 rounded-[2.5rem] overflow-hidden shadow-2xl relative"
              >
                {/* Visual Image Container - Left Side */}
                <div className="w-full md:w-[45%] aspect-video md:aspect-auto bg-zinc-950 relative overflow-hidden shrink-0 border-b md:border-b-0 md:border-r border-white/5">
                  <img 
                    src={tool.image} 
                    alt={tool.title}
                  ...
                  {/* Absolute Badge inside image */}
                  <span className="absolute top-4 left-4 bg-blue-600/10 border border-blue-500/30 text-white text-[8px] font-black uppercase tracking-widest px-2.5 py-1 rounded shadow-md">
                    {tool.badge}
                  </span>
                </div>

                {/* Text Content Container - Right Side */}
                <div className="w-full md:w-[55%] p-6 flex flex-col justify-between items-start space-y-8 bg-gradient-to-br from-transparent to-[#02081c]">
                  <div className="space-y-1.5 w-full">
                    <div className="w-10 h-10 rounded-xl bg-blue-600/10 flex items-center justify-center mb-4 group-hover:bg-blue-600 group-hover:text-white transition-colors text-blue-400">
                      {tool.icon}
                    </div>
                    <h3 className="text-3xl font-black uppercase tracking-tighter text-white group-hover:text-cyan-400 transition-colors leading-none">
                      {tool.title}
                    </h3>
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                <div className="space-y-5">
                  ...
                  <p className="text-zinc-400 text-sm md:text-base max-w-xl leading-relaxed">
                    Hum aapko basic zero scratch se sikhana shuru karte hain aur institutional pro level tak lekar jate hain. Complete mapping matrices guide.
                  </p>
            ...
            <div className="lg:col-span-5 flex flex-col gap-6">
              ...
              >
                ...
                <p className="text-xs font-medium mt-3 leading-relaxed opacity-90">
                  Course fee zero hai. Aapko sirf <span className="underline font-black">Center Charges</span> pay karne honge luxury premium facility lab access ke liye.
                </p>
        ...
        >
          ...
          <div className="md:col-span-3 flex justify-end">
            <button className="flex items-center gap-2.5 bg-red-600/10 border border-red-500/20 hover:bg-red-600 hover:text-white transition-all text-white font-bold text-[10px] tracking-widest uppercase py-3 px-6 rounded-xl shadow-lg shadow-red-600/10">
